...
/*
Класс простая коллекция, с возможностью итерироваться по своим элементам.
 */
    ...
    public Iterator<T> iterator() {
        return new Iterator<T>() {
            ...
            public boolean hasNext() {
                ...
                //если Index < это значит что он в пределах эл.контейнера и не все элементы пройдены
            }
